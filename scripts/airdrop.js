...
async function main() {
    ...
    const wordNft = await WordNft.attach(config.contract_address);

    const resp = await wordNft.airdrop("0x5d097492e2FB156696Ad1f16cB5C478cFcAEBAEB", 1);
    console.log("WordNft airdrop done: ", resp);
}
